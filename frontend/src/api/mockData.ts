...
export const mockMeetingPrep: import('./client').MeetingPrepResponse = {
  meeting_id: 'm1',
  meeting_title: '1:1 with Alice',
  meeting_date: '2026-07-10',
  meeting_time: '09:00',
  attendees: ['Alice Chen'],
  resolved_attendees: [
    { person_name: 'Alice Chen', relationship: 'direct_report', evidence_source: 'entity_resolver', evidence_path: 'Alice Chen', warnings: [] },
  ],
  matched_rule_id: '1-on-1',
  matched_rule_name: 'Direct Report 1:1',
  meeting_type: '1:1',
  prep_required: true,
  why_this_rule_matched: '1:1 with direct report',
  sections: {
    changes: [{ type: 'note', title: 'Project update', detail: 'Alice shared progress on Acme Corp', entity: 'Acme Corp', date: '2026-07-09' }],
    risks: [{ type: 'risk', title: 'Resource gap', detail: 'Team needs additional headcount', entity: 'Engineering', severity: 'high' }],
    questions: [{ type: 'question', title: 'Career growth', detail: 'Discuss promotion timeline', entity: 'Alice Chen' }],
  },
  sources_consulted: ['Recent notes', 'Action items'],
  sources_selected: ['Recent notes', 'Action items'],
  sources_excluded: [],
...
export const mockManagerStandupPrep: import('./client').MeetingPrepResponse = {
  meeting_id: 'm2',
  ...
  resolved_attendees: [
    { person_name: 'Chris Presley', relationship: 'manager', evidence_source: 'entity_resolver', evidence_path: 'Chris Presley', warnings: [] },
  ],
  matched_rule_id: 'standup',
  matched_rule_name: 'Manager Standup',
  meeting_type: 'standup',
  prep_required: true,
  why_this_rule_matched: 'Standup with manager',
  sections: {},
  sources_consulted: [],
  sources_selected: [],
  sources_excluded: [],
...
export const mockNoPrepEvent: import('./client').MeetingPrepResponse = {
  meeting_id: 'm3',
  ...
  attendees: [],
  resolved_attendees: [],
  matched_rule_id: 'no-prep',
  matched_rule_name: 'No Preparation Needed',
  meeting_type: 'focus',
  prep_required: false,
  why_this_rule_matched: 'No preparation needed for this meeting type',
  sections: {},
  sources_consulted: [],
  sources_selected: [],
  sources_excluded: [],
